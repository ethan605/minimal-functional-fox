...
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/ethan605/minimal-functional-fox/master/install.sh)"
```
...
```bash
curl -Lo install.sh https://raw.githubusercontent.com/ethan605/minimal-functional-fox/master/install.sh
sh install.sh
```
